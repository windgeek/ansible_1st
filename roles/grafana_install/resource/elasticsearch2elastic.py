...
elasticServer = os.environ.get('ES_METRICS_CLUSTER_URL', 'http://172.24.5.84:9200')
...
elasticMonitoringCluster = os.environ.get('ES_METRICS_MONITORING_CLUSTER_URL', 'http://172.24.5.84:9200')
